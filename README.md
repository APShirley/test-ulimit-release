Demos an issue introduced in `ubuntu-xenial` and not affecting `ubuntu-trusty` bosh stemcells regarding ulimits when forking a process using `su` and how to fix it.
